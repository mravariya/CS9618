# Guided examples — Networks Including the Internet
...
## Example D — Communication linkage

**Question:** Link **one idea** from `Networks Including the Internet` to another objective in **Communication**.
