# Animation — Networks Including the Internet

## Purpose

Visual, step-by-step intuition for **Networks Including the Internet** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `NetworksIncludingTheInternetModuleOverview`
...
```bash
manim -pql animations/scene.py NetworksIncludingTheInternetModuleOverview
```
