# Networks Including the Internet
        ...
        **Syllabus:** Cambridge International AS & A Level Computer Science **9618** (Section 2.1)  
...
| --- | --- |
| **LAN** | Relates to this unit; define using your own words and the official syllabus. |
| **WAN** | Relates to this unit; define using your own words and the official syllabus. |
| **TCP/IP** | Relates to this unit; define using your own words and the official syllabus. |
| **DNS** | Relates to this unit; define using your own words and the official syllabus. |
| **URL** | Relates to this unit; define using your own words and the official syllabus. |
| **topology** | Relates to this unit; define using your own words and the official syllabus. |
| **router** | Relates to this unit; define using your own words and the official syllabus. |
| **cloud** | Relates to this unit; define using your own words and the official syllabus. |
        ...
        This subtopic sits inside **Communication**. At 9618 level, examiners reward **precise vocabulary** tied to **short explanations**. Start from a concrete picture (a device, a file, a wire), then name the abstract idea.
