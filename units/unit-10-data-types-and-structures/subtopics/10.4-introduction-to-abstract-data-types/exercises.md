# Practice — Introduction to Abstract Data Types (ADT)

## Short answer

1. **State** the main focus of `Introduction to Abstract Data Types (ADT)` in one sentence.
...
A school migrates systems. Give **two risks** and **two controls** relevant to `Introduction to Abstract Data Types (ADT)`.
