# Animation — Data Types and Records

## Purpose

Visual, step-by-step intuition for **Data Types and Records** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `DataTypesAndRecordsModuleOverview`
...
```bash
manim -pql animations/scene.py DataTypesAndRecordsModuleOverview
```
