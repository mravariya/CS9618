# Guided examples — Introduction to Abstract Data Types (ADT)
...
## Example D — Data Types and Structures linkage

**Question:** Link **one idea** from `Introduction to Abstract Data Types (ADT)` to another objective in **Data Types and Structures**.
