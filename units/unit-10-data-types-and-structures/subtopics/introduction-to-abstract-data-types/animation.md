# Animation — Introduction to Abstract Data Types (ADT)

## Purpose

Visual, step-by-step intuition for **Introduction to Abstract Data Types (ADT)** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `IntroductionToAbstractDataTypesModuleOverview`
...
```bash
manim -pql animations/scene.py IntroductionToAbstractDataTypesModuleOverview
```
