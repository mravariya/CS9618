# Practice — Data Types and Records

## Short answer

1. **State** the main focus of `Data Types and Records` in one sentence.
...
A school migrates systems. Give **two risks** and **two controls** relevant to `Data Types and Records`.
