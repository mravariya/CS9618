...
Visual, step-by-step intuition for **Arrays** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `ArraysModuleOverview`
...
```bash
manim -pql animations/scene.py ArraysModuleOverview
```
