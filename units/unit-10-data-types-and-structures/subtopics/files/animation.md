...
Visual, step-by-step intuition for **Files** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.
...
```bash
manim -pql animations/scene.py FilesModuleOverview
```
