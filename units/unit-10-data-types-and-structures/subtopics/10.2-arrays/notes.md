# Arrays
        ...
        **Syllabus:** Cambridge International AS & A Level Computer Science **9618** (Section 10.2)  
...
| --- | --- |
| **record** | Relates to this unit; define using your own words and the official syllabus. |
| **array** | Relates to this unit; define using your own words and the official syllabus. |
| **index** | Relates to this unit; define using your own words and the official syllabus. |
| **stack** | Relates to this unit; define using your own words and the official syllabus. |
| **queue** | Relates to this unit; define using your own words and the official syllabus. |
| **linked list** | Relates to this unit; define using your own words and the official syllabus. |
| **ADT** | Relates to this unit; define using your own words and the official syllabus. |
        ...
        This subtopic sits inside **Data Types and Structures**. At 9618 level, examiners reward **precise vocabulary** tied to **short explanations**. Start from a concrete picture (a device, a file, a wire), then name the abstract idea.
