# Animation — File Processing and Exception Handling

## Purpose

Visual, step-by-step intuition for **File Processing and Exception Handling** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `FileProcessingAndExceptionHandlingModuleOverview`
...
```bash
manim -pql animations/scene.py FileProcessingAndExceptionHandlingModuleOverview
```
