# File Processing and Exception Handling
        ...
        **Syllabus:** Cambridge International AS & A Level Computer Science **9618** (Section 20.2)  
...
| --- | --- |
| **OOP** | Relates to this unit; define using your own words and the official syllabus. |
| **declarative** | Relates to this unit; define using your own words and the official syllabus. |
| **inheritance** | Relates to this unit; define using your own words and the official syllabus. |
| **exception** | Relates to this unit; define using your own words and the official syllabus. |
| **random file** | Relates to this unit; define using your own words and the official syllabus. |
        ...
        This subtopic sits inside **Further Programming**. At 9618 level, examiners reward **precise vocabulary** tied to **short explanations**. Start from a concrete picture (a device, a file, a wire), then name the abstract idea.
