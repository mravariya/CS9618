# Animation — Programming Paradigms

## Purpose

Visual, step-by-step intuition for **Programming Paradigms** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `ProgrammingParadigmsModuleOverview`
...
```bash
manim -pql animations/scene.py ProgrammingParadigmsModuleOverview
```
