# Guided examples — File Processing and Exception Handling
...
## Example D — Further Programming linkage

**Question:** Link **one idea** from `File Processing and Exception Handling` to another objective in **Further Programming**.
