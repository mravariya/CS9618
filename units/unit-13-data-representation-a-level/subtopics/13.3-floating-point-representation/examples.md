# Guided examples — Floating-point Representation and Manipulation
...
## Example D — Data Representation (A Level) linkage

**Question:** Link **one idea** from `Floating-point Representation and Manipulation` to another objective in **Data Representation (A Level)**.
