# User-defined Data Types
        ...
        **Syllabus:** Cambridge International AS & A Level Computer Science **9618** (Section 13.1)  
...
| --- | --- |
| **enumerated type** | Relates to this unit; define using your own words and the official syllabus. |
| **pointer** | Relates to this unit; define using your own words and the official syllabus. |
| **hashing** | Relates to this unit; define using your own words and the official syllabus. |
| **mantissa** | Relates to this unit; define using your own words and the official syllabus. |
| **exponent** | Relates to this unit; define using your own words and the official syllabus. |
| **normalisation** | Relates to this unit; define using your own words and the official syllabus. |
        ...
        This subtopic sits inside **Data Representation (A Level)**. At 9618 level, examiners reward **precise vocabulary** tied to **short explanations**. Start from a concrete picture (a device, a file, a wire), then name the abstract idea.
