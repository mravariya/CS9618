# Animation — User-defined Data Types

## Purpose

Visual, step-by-step intuition for **User-defined Data Types** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `UserDefinedDataTypesModuleOverview`
...
```bash
manim -pql animations/scene.py UserDefinedDataTypesModuleOverview
```
