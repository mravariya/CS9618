# Guided examples — File Organisation and Access
...
**Question:** Link **one idea** from `File Organisation and Access` to another objective in **Data Representation (A Level)**.
