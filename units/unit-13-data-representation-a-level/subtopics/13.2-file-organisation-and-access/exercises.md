# Practice — File Organisation and Access

## Short answer

1. **State** the main focus of `File Organisation and Access` in one sentence.
...
A school migrates systems. Give **two risks** and **two controls** relevant to `File Organisation and Access`.
