# Animation — File Organisation and Access

## Purpose

Visual, step-by-step intuition for **File Organisation and Access** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `FileOrganisationAndAccessModuleOverview`
...
```bash
manim -pql animations/scene.py FileOrganisationAndAccessModuleOverview
```
