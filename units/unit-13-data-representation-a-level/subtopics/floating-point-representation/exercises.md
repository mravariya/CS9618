# Practice — Floating-point Representation and Manipulation

## Short answer

1. **State** the main focus of `Floating-point Representation and Manipulation` in one sentence.
...
A school migrates systems. Give **two risks** and **two controls** relevant to `Floating-point Representation and Manipulation`.
