# Animation — Floating-point Representation and Manipulation

## Purpose

Visual, step-by-step intuition for **Floating-point Representation and Manipulation** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `FloatingPointRepresentationModuleOverview`
...
```bash
manim -pql animations/scene.py FloatingPointRepresentationModuleOverview
```
