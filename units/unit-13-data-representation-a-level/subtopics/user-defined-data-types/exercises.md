# Practice — User-defined Data Types

## Short answer

1. **State** the main focus of `User-defined Data Types` in one sentence.
...
A school migrates systems. Give **two risks** and **two controls** relevant to `User-defined Data Types`.
