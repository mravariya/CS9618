# Practice — Program Testing and Maintenance

## Short answer

1. **State** the main focus of `Program Testing and Maintenance` in one sentence.
...
A school migrates systems. Give **two risks** and **two controls** relevant to `Program Testing and Maintenance`.
