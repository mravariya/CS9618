# Animation — Program Testing and Maintenance

## Purpose

Visual, step-by-step intuition for **Program Testing and Maintenance** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `ProgramTestingAndMaintenanceModuleOverview`
...
```bash
manim -pql animations/scene.py ProgramTestingAndMaintenanceModuleOverview
```
