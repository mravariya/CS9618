# Animation — Program Design

## Purpose

Visual, step-by-step intuition for **Program Design** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `ProgramDesignModuleOverview`
...
```bash
manim -pql animations/scene.py ProgramDesignModuleOverview
```
