# Animation — Program Development Life Cycle

## Purpose

Visual, step-by-step intuition for **Program Development Life Cycle** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `ProgramDevelopmentLifecycleModuleOverview`
...
```bash
manim -pql animations/scene.py ProgramDevelopmentLifecycleModuleOverview
```
