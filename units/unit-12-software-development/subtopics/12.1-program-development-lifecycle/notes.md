# Program Development Life Cycle
        ...
        **Syllabus:** Cambridge International AS & A Level Computer Science **9618** (Section 12.1)  
...
| --- | --- |
| **waterfall** | Relates to this unit; define using your own words and the official syllabus. |
| **RAD** | Relates to this unit; define using your own words and the official syllabus. |
| **structure chart** | Relates to this unit; define using your own words and the official syllabus. |
| **black-box testing** | Relates to this unit; define using your own words and the official syllabus. |
| **maintenance** | Relates to this unit; define using your own words and the official syllabus. |
        ...
        This subtopic sits inside **Software Development**. At 9618 level, examiners reward **precise vocabulary** tied to **short explanations**. Start from a concrete picture (a device, a file, a wire), then name the abstract idea.
