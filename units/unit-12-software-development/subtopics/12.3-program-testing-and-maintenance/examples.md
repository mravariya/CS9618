# Guided examples — Program Testing and Maintenance
...
## Example D — Software Development linkage

**Question:** Link **one idea** from `Program Testing and Maintenance` to another objective in **Software Development**.
