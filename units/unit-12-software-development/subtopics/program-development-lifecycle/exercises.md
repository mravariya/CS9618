# Practice — Program Development Life Cycle

## Short answer

1. **State** the main focus of `Program Development Life Cycle` in one sentence.
...
A school migrates systems. Give **two risks** and **two controls** relevant to `Program Development Life Cycle`.
