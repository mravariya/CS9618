# Animation — DDL and DML (SQL)

## Purpose

Visual, step-by-step intuition for **DDL and DML (SQL)** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `DdlAndDmlModuleOverview`
...
```bash
manim -pql animations/scene.py DdlAndDmlModuleOverview
```
