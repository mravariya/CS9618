# Practice — DDL and DML (SQL)

## Short answer

1. **State** the main focus of `DDL and DML (SQL)` in one sentence.
...
A school migrates systems. Give **two risks** and **two controls** relevant to `DDL and DML (SQL)`.
