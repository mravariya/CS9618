# Database Concepts
        ...
        **Syllabus:** Cambridge International AS & A Level Computer Science **9618** (Section 8.1)  
...
| --- | --- |
| **primary key** | Relates to this unit; define using your own words and the official syllabus. |
| **foreign key** | Relates to this unit; define using your own words and the official syllabus. |
| **normalisation** | Relates to this unit; define using your own words and the official syllabus. |
| **SQL** | Relates to this unit; define using your own words and the official syllabus. |
| **DDL** | Relates to this unit; define using your own words and the official syllabus. |
| **DML** | Relates to this unit; define using your own words and the official syllabus. |
| **ER diagram** | Relates to this unit; define using your own words and the official syllabus. |
        ...
        This subtopic sits inside **Databases**. At 9618 level, examiners reward **precise vocabulary** tied to **short explanations**. Start from a concrete picture (a device, a file, a wire), then name the abstract idea.
