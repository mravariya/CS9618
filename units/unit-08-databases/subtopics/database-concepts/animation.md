# Animation — Database Concepts

## Purpose

Visual, step-by-step intuition for **Database Concepts** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `DatabaseConceptsModuleOverview`
...
```bash
manim -pql animations/scene.py DatabaseConceptsModuleOverview
```
