# Guided examples — Database Management Systems (DBMS)
...
## Example D — Databases linkage

**Question:** Link **one idea** from `Database Management Systems (DBMS)` to another objective in **Databases**.
