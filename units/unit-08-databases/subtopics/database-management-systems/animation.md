# Animation — Database Management Systems (DBMS)

## Purpose

Visual, step-by-step intuition for **Database Management Systems (DBMS)** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `DatabaseManagementSystemsModuleOverview`
...
```bash
manim -pql animations/scene.py DatabaseManagementSystemsModuleOverview
```
