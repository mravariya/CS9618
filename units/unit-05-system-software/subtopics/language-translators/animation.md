# Animation — Language Translators

## Purpose

Visual, step-by-step intuition for **Language Translators** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `LanguageTranslatorsModuleOverview`
...
```bash
manim -pql animations/scene.py LanguageTranslatorsModuleOverview
```
