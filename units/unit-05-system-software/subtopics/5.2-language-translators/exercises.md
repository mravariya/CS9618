# Practice — Language Translators

## Short answer

1. **State** the main focus of `Language Translators` in one sentence.
...
A school migrates systems. Give **two risks** and **two controls** relevant to `Language Translators`.
