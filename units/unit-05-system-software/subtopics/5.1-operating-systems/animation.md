# Animation — Operating Systems

## Purpose

Visual, step-by-step intuition for **Operating Systems** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `OperatingSystemsModuleOverview`
...
```bash
manim -pql animations/scene.py OperatingSystemsModuleOverview
```
