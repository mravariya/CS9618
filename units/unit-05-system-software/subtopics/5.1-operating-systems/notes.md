# Operating Systems
        ...
        **Syllabus:** Cambridge International AS & A Level Computer Science **9618** (Section 5.1)  
...
| --- | --- |
| **OS** | Relates to this unit; define using your own words and the official syllabus. |
| **compiler** | Relates to this unit; define using your own words and the official syllabus. |
| **interpreter** | Relates to this unit; define using your own words and the official syllabus. |
| **IDE** | Relates to this unit; define using your own words and the official syllabus. |
| **library** | Relates to this unit; define using your own words and the official syllabus. |
| **DLL** | Relates to this unit; define using your own words and the official syllabus. |
        ...
        This subtopic sits inside **System Software**. At 9618 level, examiners reward **precise vocabulary** tied to **short explanations**. Start from a concrete picture (a device, a file, a wire), then name the abstract idea.
