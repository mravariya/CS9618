# Encryption, Protocols and Digital Certificates
        ...
        **Syllabus:** Cambridge International AS & A Level Computer Science **9618** (Section 17.1)  
...
| --- | --- |
| **public key** | Relates to this unit; define using your own words and the official syllabus. |
| **symmetric** | Relates to this unit; define using your own words and the official syllabus. |
| **TLS** | Relates to this unit; define using your own words and the official syllabus. |
| **digital certificate** | Relates to this unit; define using your own words and the official syllabus. |
| **digital signature** | Relates to this unit; define using your own words and the official syllabus. |
        ...
        This subtopic sits inside **Security (A Level)**. At 9618 level, examiners reward **precise vocabulary** tied to **short explanations**. Start from a concrete picture (a device, a file, a wire), then name the abstract idea.
