# Animation — Encryption, Protocols and Digital Certificates

## Purpose

Visual, step-by-step intuition for **Encryption, Protocols and Digital Certificates** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `EncryptionAndDigitalCertificatesModuleOverview`
...
```bash
manim -pql animations/scene.py EncryptionAndDigitalCertificatesModuleOverview
```
