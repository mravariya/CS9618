# Guided examples — Encryption, Protocols and Digital Certificates
...
## Example D — Security (A Level) linkage

**Question:** Link **one idea** from `Encryption, Protocols and Digital Certificates` to another objective in **Security (A Level)**.
