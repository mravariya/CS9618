# Practice — Encryption, Protocols and Digital Certificates

## Short answer

1. **State** the main focus of `Encryption, Protocols and Digital Certificates` in one sentence.
...
A school migrates systems. Give **two risks** and **two controls** relevant to `Encryption, Protocols and Digital Certificates`.
