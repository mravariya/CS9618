# Animation — Purposes of an Operating System

## Purpose

Visual, step-by-step intuition for **Purposes of an Operating System** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `PurposesOfAnOperatingSystemModuleOverview`
...
```bash
manim -pql animations/scene.py PurposesOfAnOperatingSystemModuleOverview
```
