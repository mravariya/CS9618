# Purposes of an Operating System
        ...
        **Syllabus:** Cambridge International AS & A Level Computer Science **9618** (Section 16.1)  
...
| --- | --- |
| **scheduler** | Relates to this unit; define using your own words and the official syllabus. |
| **paging** | Relates to this unit; define using your own words and the official syllabus. |
| **thrashing** | Relates to this unit; define using your own words and the official syllabus. |
| **lexical analysis** | Relates to this unit; define using your own words and the official syllabus. |
| **BNF** | Relates to this unit; define using your own words and the official syllabus. |
| **RPN** | Relates to this unit; define using your own words and the official syllabus. |
        ...
        This subtopic sits inside **System Software (A Level)**. At 9618 level, examiners reward **precise vocabulary** tied to **short explanations**. Start from a concrete picture (a device, a file, a wire), then name the abstract idea.
