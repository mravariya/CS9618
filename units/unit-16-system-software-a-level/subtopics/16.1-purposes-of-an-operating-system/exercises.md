# Practice — Purposes of an Operating System

## Short answer

1. **State** the main focus of `Purposes of an Operating System` in one sentence.
...
A school migrates systems. Give **two risks** and **two controls** relevant to `Purposes of an Operating System`.
