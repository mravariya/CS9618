# Animation — Translation Software

## Purpose

Visual, step-by-step intuition for **Translation Software** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `TranslationSoftwareModuleOverview`
...
```bash
manim -pql animations/scene.py TranslationSoftwareModuleOverview
```
