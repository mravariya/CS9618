# Practice — Translation Software

## Short answer

1. **State** the main focus of `Translation Software` in one sentence.
...
A school migrates systems. Give **two risks** and **two controls** relevant to `Translation Software`.
