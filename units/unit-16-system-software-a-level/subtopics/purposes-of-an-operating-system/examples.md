# Guided examples — Purposes of an Operating System
...
## Example D — System Software (A Level) linkage

**Question:** Link **one idea** from `Purposes of an Operating System` to another objective in **System Software (A Level)**.
