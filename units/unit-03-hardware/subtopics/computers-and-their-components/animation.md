# Animation — Computers and Their Components

## Purpose

Visual, step-by-step intuition for **Computers and Their Components** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `ComputersAndTheirComponentsModuleOverview`
...
```bash
manim -pql animations/scene.py ComputersAndTheirComponentsModuleOverview
```
