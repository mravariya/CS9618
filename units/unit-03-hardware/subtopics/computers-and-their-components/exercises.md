# Practice — Computers and Their Components

## Short answer

1. **State** the main focus of `Computers and Their Components` in one sentence.
...
A school migrates systems. Give **two risks** and **two controls** relevant to `Computers and Their Components`.
