# Practice — Logic Gates and Logic Circuits

## Short answer

1. **State** the main focus of `Logic Gates and Logic Circuits` in one sentence.
...
A school migrates systems. Give **two risks** and **two controls** relevant to `Logic Gates and Logic Circuits`.
