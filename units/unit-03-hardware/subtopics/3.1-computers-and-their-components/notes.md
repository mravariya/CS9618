# Computers and Their Components
        ...
        **Syllabus:** Cambridge International AS & A Level Computer Science **9618** (Section 3.1)  
...
- Monitoring vs control; sensors and actuators; feedback.
        ...
        | Term | Working definition (for study) |
| --- | --- |
| **RAM** | Relates to this unit; define using your own words and the official syllabus. |
| **ROM** | Relates to this unit; define using your own words and the official syllabus. |
| **SRAM** | Relates to this unit; define using your own words and the official syllabus. |
| **DRAM** | Relates to this unit; define using your own words and the official syllabus. |
| **sensor** | Relates to this unit; define using your own words and the official syllabus. |
| **actuator** | Relates to this unit; define using your own words and the official syllabus. |
| **logic gate** | Relates to this unit; define using your own words and the official syllabus. |
| **truth table** | Relates to this unit; define using your own words and the official syllabus. |
        ...
        This subtopic sits inside **Hardware**. At 9618 level, examiners reward **precise vocabulary** tied to **short explanations**. Start from a concrete picture (a device, a file, a wire), then name the abstract idea.
        ...
        See [animation.md](animation.md) and render scenes in `animations/scene.py`.
