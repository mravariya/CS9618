# Guided examples — Computers and Their Components
...
## Example D — Hardware linkage

**Question:** Link **one idea** from `Computers and Their Components` to another objective in **Hardware**.
