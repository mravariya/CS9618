# Guided examples — Circuit Switching and Packet Switching
...
## Example D — Communication and Internet Technologies linkage

**Question:** Link **one idea** from `Circuit Switching and Packet Switching` to another objective in **Communication and Internet Technologies**.
