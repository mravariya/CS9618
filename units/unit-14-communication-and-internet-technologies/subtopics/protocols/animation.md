...
Visual, step-by-step intuition for **Protocols** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `ProtocolsModuleOverview`
...
```bash
manim -pql animations/scene.py ProtocolsModuleOverview
```
