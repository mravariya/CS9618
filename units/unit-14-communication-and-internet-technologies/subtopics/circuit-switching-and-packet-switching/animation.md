# Animation — Circuit Switching and Packet Switching

## Purpose

Visual, step-by-step intuition for **Circuit Switching and Packet Switching** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `CircuitSwitchingAndPacketSwitchingModuleOverview`
...
```bash
manim -pql animations/scene.py CircuitSwitchingAndPacketSwitchingModuleOverview
```
