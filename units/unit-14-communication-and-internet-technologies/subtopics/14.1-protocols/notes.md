# Protocols
        ...
        **Syllabus:** Cambridge International AS & A Level Computer Science **9618** (Section 14.1)  
...
| **HTTP** | Relates to this unit; define using your own words and the official syllabus. |
| **FTP** | Relates to this unit; define using your own words and the official syllabus. |
| **packet switching** | Relates to this unit; define using your own words and the official syllabus. |
| **circuit switching** | Relates to this unit; define using your own words and the official syllabus. |
| **router** | Relates to this unit; define using your own words and the official syllabus. |
        ...
        This subtopic sits inside **Communication and Internet Technologies**. At 9618 level, examiners reward **precise vocabulary** tied to **short explanations**. Start from a concrete picture (a device, a file, a wire), then name the abstract idea.
