# Animation — Data Security

## Purpose

Visual, step-by-step intuition for **Data Security** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `DataSecurityModuleOverview`
...
```bash
manim -pql animations/scene.py DataSecurityModuleOverview
```
