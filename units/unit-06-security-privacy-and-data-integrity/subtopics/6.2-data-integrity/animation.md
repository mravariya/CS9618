...
Visual, step-by-step intuition for **Data Integrity** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `DataIntegrityModuleOverview`
...
```bash
manim -pql animations/scene.py DataIntegrityModuleOverview
```
