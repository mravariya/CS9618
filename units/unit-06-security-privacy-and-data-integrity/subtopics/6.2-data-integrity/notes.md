# Data Integrity
        ...
        **Syllabus:** Cambridge International AS & A Level Computer Science **9618** (Section 6.2)  
...
| --- | --- |
| **encryption** | Relates to this unit; define using your own words and the official syllabus. |
| **firewall** | Relates to this unit; define using your own words and the official syllabus. |
| **malware** | Relates to this unit; define using your own words and the official syllabus. |
| **validation** | Relates to this unit; define using your own words and the official syllabus. |
| **checksum** | Relates to this unit; define using your own words and the official syllabus. |
| **parity** | Relates to this unit; define using your own words and the official syllabus. |
        ...
        This subtopic sits inside **Security, Privacy and Data Integrity**. At 9618 level, examiners reward **precise vocabulary** tied to **short explanations**. Start from a concrete picture (a device, a file, a wire), then name the abstract idea.
