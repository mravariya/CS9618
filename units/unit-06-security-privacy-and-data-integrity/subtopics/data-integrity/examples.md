# Guided examples — Data Integrity
...
## Example D — Security, Privacy and Data Integrity linkage

**Question:** Link **one idea** from `Data Integrity` to another objective in **Security, Privacy and Data Integrity**.
