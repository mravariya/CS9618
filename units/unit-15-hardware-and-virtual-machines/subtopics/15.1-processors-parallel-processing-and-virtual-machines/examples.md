# Guided examples — Processors, Parallel Processing and Virtual Machines
...
## Example D — Hardware and Virtual Machines linkage

**Question:** Link **one idea** from `Processors, Parallel Processing and Virtual Machines` to another objective in **Hardware and Virtual Machines**.
