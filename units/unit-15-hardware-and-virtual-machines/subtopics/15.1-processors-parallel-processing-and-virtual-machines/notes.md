# Processors, Parallel Processing and Virtual Machines
        ...
        **Syllabus:** Cambridge International AS & A Level Computer Science **9618** (Section 15.1)  
...
| --- | --- |
| **RISC** | Relates to this unit; define using your own words and the official syllabus. |
| **CISC** | Relates to this unit; define using your own words and the official syllabus. |
| **MIMD** | Relates to this unit; define using your own words and the official syllabus. |
| **virtual machine** | Relates to this unit; define using your own words and the official syllabus. |
| **Karnaugh map** | Relates to this unit; define using your own words and the official syllabus. |
| **flip-flop** | Relates to this unit; define using your own words and the official syllabus. |
        ...
        This subtopic sits inside **Hardware and Virtual Machines**. At 9618 level, examiners reward **precise vocabulary** tied to **short explanations**. Start from a concrete picture (a device, a file, a wire), then name the abstract idea.
