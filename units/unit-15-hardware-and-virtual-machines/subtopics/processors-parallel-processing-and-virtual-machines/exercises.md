# Practice — Processors, Parallel Processing and Virtual Machines

## Short answer

1. **State** the main focus of `Processors, Parallel Processing and Virtual Machines` in one sentence.
...
A school migrates systems. Give **two risks** and **two controls** relevant to `Processors, Parallel Processing and Virtual Machines`.
