# Practice — Boolean Algebra and Logic Circuits

## Short answer

1. **State** the main focus of `Boolean Algebra and Logic Circuits` in one sentence.
...
A school migrates systems. Give **two risks** and **two controls** relevant to `Boolean Algebra and Logic Circuits`.
