# Animation — Boolean Algebra and Logic Circuits

## Purpose

Visual, step-by-step intuition for **Boolean Algebra and Logic Circuits** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `BooleanAlgebraAndLogicCircuitsModuleOverview`
...
```bash
manim -pql animations/scene.py BooleanAlgebraAndLogicCircuitsModuleOverview
```
