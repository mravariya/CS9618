# Animation — Algorithms and Abstract Data Types

## Purpose

Visual, step-by-step intuition for **Algorithms and Abstract Data Types** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `AlgorithmsAndAdtsModuleOverview`
...
```bash
manim -pql animations/scene.py AlgorithmsAndAdtsModuleOverview
```
