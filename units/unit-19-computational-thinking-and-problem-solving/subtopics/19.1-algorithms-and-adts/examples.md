# Guided examples — Algorithms and Abstract Data Types
...
## Example D — Computational Thinking and Problem-solving linkage

**Question:** Link **one idea** from `Algorithms and Abstract Data Types` to another objective in **Computational Thinking and Problem-solving**.
