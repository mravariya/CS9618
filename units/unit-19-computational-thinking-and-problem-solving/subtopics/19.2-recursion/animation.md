...
Visual, step-by-step intuition for **Recursion** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `RecursionModuleOverview`
...
```bash
manim -pql animations/scene.py RecursionModuleOverview
```
