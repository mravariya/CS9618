# Recursion
        ...
        **Syllabus:** Cambridge International AS & A Level Computer Science **9618** (Section 19.2)  
...
| --- | --- |
| **binary search** | Relates to this unit; define using your own words and the official syllabus. |
| **Big O** | Relates to this unit; define using your own words and the official syllabus. |
| **recursion** | Relates to this unit; define using your own words and the official syllabus. |
| **binary tree** | Relates to this unit; define using your own words and the official syllabus. |
| **ADT implementation** | Relates to this unit; define using your own words and the official syllabus. |
        ...
        This subtopic sits inside **Computational Thinking and Problem-solving**. At 9618 level, examiners reward **precise vocabulary** tied to **short explanations**. Start from a concrete picture (a device, a file, a wire), then name the abstract idea.
