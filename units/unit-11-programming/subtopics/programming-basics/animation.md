...
Visual, step-by-step intuition for **Programming Basics** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `ProgrammingBasicsModuleOverview`
...
```bash
manim -pql animations/scene.py ProgrammingBasicsModuleOverview
```
