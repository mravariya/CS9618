...
Visual, step-by-step intuition for **Constructs** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `ConstructsModuleOverview`
...
```bash
manim -pql animations/scene.py ConstructsModuleOverview
```
