# Guided examples — Structured Programming
...
## Example D — Programming linkage

**Question:** Link **one idea** from `Structured Programming` to another objective in **Programming**.
