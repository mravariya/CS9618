# Animation — Structured Programming

## Purpose

Visual, step-by-step intuition for **Structured Programming** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `StructuredProgrammingModuleOverview`
...
```bash
manim -pql animations/scene.py StructuredProgrammingModuleOverview
```
