...
1. **State** the main focus of `Structured Programming` in one sentence.
...
A school migrates systems. Give **two risks** and **two controls** relevant to `Structured Programming`.
