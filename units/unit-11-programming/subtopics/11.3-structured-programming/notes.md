# Structured Programming
        ...
        **Syllabus:** Cambridge International AS & A Level Computer Science **9618** (Section 11.3)  
...
| --- | --- |
| **variable** | Relates to this unit; define using your own words and the official syllabus. |
| **constant** | Relates to this unit; define using your own words and the official syllabus. |
| **procedure** | Relates to this unit; define using your own words and the official syllabus. |
| **function** | Relates to this unit; define using your own words and the official syllabus. |
| **parameter** | Relates to this unit; define using your own words and the official syllabus. |
| **loop** | Relates to this unit; define using your own words and the official syllabus. |
| **selection** | Relates to this unit; define using your own words and the official syllabus. |
        ...
        This subtopic sits inside **Programming**. At 9618 level, examiners reward **precise vocabulary** tied to **short explanations**. Start from a concrete picture (a device, a file, a wire), then name the abstract idea.
