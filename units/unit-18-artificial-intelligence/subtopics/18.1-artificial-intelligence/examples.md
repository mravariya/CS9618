# Guided examples — Artificial Intelligence
...
## Example D — Artificial Intelligence (AI) linkage

**Question:** Link **one idea** from `Artificial Intelligence` to another objective in **Artificial Intelligence (AI)**.
