...
Visual, step-by-step intuition for **Artificial Intelligence** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `ArtificialIntelligenceModuleOverview`
...
```bash
manim -pql animations/scene.py ArtificialIntelligenceModuleOverview
```
