# Artificial Intelligence
        ...
        **Syllabus:** Cambridge International AS & A Level Computer Science **9618** (Section 18.1)  
...
| --- | --- |
| **A*** | Relates to this unit; define using your own words and the official syllabus. |
| **Dijkstra** | Relates to this unit; define using your own words and the official syllabus. |
| **supervised learning** | Relates to this unit; define using your own words and the official syllabus. |
| **neural network** | Relates to this unit; define using your own words and the official syllabus. |
| **back propagation** | Relates to this unit; define using your own words and the official syllabus. |
        ...
        This subtopic sits inside **Artificial Intelligence (AI)**. At 9618 level, examiners reward **precise vocabulary** tied to **short explanations**. Start from a concrete picture (a device, a file, a wire), then name the abstract idea.
