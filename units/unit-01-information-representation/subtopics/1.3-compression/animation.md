...
Visual, step-by-step intuition for **Compression** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `CompressionModuleOverview`
...
```bash
manim -pql animations/scene.py CompressionModuleOverview
```
