# Multimedia — Graphics and Sound
        ...
        **Syllabus:** Cambridge International AS & A Level Computer Science **9618** (Section 1.2)  
...
| **BCD** | Relates to this unit; define using your own words and the official syllabus. |
| **two's complement** | Relates to this unit; define using your own words and the official syllabus. |
| **Unicode** | Relates to this unit; define using your own words and the official syllabus. |
| **sampling** | Relates to this unit; define using your own words and the official syllabus. |
| **lossy** | Relates to this unit; define using your own words and the official syllabus. |
| **lossless** | Relates to this unit; define using your own words and the official syllabus. |
| **RLE** | Relates to this unit; define using your own words and the official syllabus. |
        ...
        This subtopic sits inside **Information Representation**. At 9618 level, examiners reward **precise vocabulary** tied to **short explanations**. Start from a concrete picture (a device, a file, a wire), then name the abstract idea.
