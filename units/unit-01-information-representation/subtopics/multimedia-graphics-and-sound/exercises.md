# Practice — Multimedia — Graphics and Sound

## Short answer

1. **State** the main focus of `Multimedia — Graphics and Sound` in one sentence.
...
A school migrates systems. Give **two risks** and **two controls** relevant to `Multimedia — Graphics and Sound`.
