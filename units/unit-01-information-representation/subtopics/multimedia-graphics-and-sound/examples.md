# Guided examples — Multimedia — Graphics and Sound
...
## Example D — Information Representation linkage

**Question:** Link **one idea** from `Multimedia — Graphics and Sound` to another objective in **Information Representation**.
