# Animation — Multimedia — Graphics and Sound

## Purpose

Visual, step-by-step intuition for **Multimedia — Graphics and Sound** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `MultimediaGraphicsAndSoundModuleOverview`
...
```bash
manim -pql animations/scene.py MultimediaGraphicsAndSoundModuleOverview
```
