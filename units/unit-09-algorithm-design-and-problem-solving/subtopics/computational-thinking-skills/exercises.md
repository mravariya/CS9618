...
1. **State** the main focus of `Computational Thinking Skills` in one sentence.
...
A school migrates systems. Give **two risks** and **two controls** relevant to `Computational Thinking Skills`.
