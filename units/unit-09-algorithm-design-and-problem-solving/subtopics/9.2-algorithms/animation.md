...
Visual, step-by-step intuition for **Algorithms** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `AlgorithmsModuleOverview`
...
```bash
manim -pql animations/scene.py AlgorithmsModuleOverview
```
