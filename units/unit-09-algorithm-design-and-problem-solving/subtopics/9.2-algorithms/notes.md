# Algorithms
        ...
        **Syllabus:** Cambridge International AS & A Level Computer Science **9618** (Section 9.2)  
...
| --- | --- |
| **abstraction** | Relates to this unit; define using your own words and the official syllabus. |
| **decomposition** | Relates to this unit; define using your own words and the official syllabus. |
| **pseudocode** | Relates to this unit; define using your own words and the official syllabus. |
| **flowchart** | Relates to this unit; define using your own words and the official syllabus. |
| **stepwise refinement** | Relates to this unit; define using your own words and the official syllabus. |
        ...
        This subtopic sits inside **Algorithm Design and Problem-solving**. At 9618 level, examiners reward **precise vocabulary** tied to **short explanations**. Start from a concrete picture (a device, a file, a wire), then name the abstract idea.
