# Guided examples — Computational Thinking Skills
...
## Example D — Algorithm Design and Problem-solving linkage

**Question:** Link **one idea** from `Computational Thinking Skills` to another objective in **Algorithm Design and Problem-solving**.
