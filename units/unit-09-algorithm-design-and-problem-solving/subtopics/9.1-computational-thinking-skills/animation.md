# Animation — Computational Thinking Skills

## Purpose

Visual, step-by-step intuition for **Computational Thinking Skills** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `ComputationalThinkingSkillsModuleOverview`
...
```bash
manim -pql animations/scene.py ComputationalThinkingSkillsModuleOverview
```
