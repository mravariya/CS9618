# Algorithm Design and Problem-solving
        ...
        **Level:** AS Level · **Primary assessment:** Paper 2  
        **Key concepts (Scheme of Work):** KC1
...
- Translate between structured English, flowchart, and pseudocode; stepwise refinement; logic statements.
        ...
        - **Scheme of Work:** **28** guided hours; integrate **continuously** across the course.

        ## Key terms

        `abstraction`, `decomposition`, `pseudocode`, `flowchart`, `stepwise refinement`
