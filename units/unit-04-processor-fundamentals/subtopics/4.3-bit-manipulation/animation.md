# Animation — Bit Manipulation

## Purpose

Visual, step-by-step intuition for **Bit Manipulation** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `BitManipulationModuleOverview`
...
```bash
manim -pql animations/scene.py BitManipulationModuleOverview
```
