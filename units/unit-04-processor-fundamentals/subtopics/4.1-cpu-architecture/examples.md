# Guided examples — Central Processing Unit (CPU) Architecture
...
## Example D — Processor Fundamentals linkage

**Question:** Link **one idea** from `Central Processing Unit (CPU) Architecture` to another objective in **Processor Fundamentals**.
