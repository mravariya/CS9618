# Central Processing Unit (CPU) Architecture
        ...
        **Syllabus:** Cambridge International AS & A Level Computer Science **9618** (Section 4.1)  
...
| --- | --- |
| **Von Neumann** | Relates to this unit; define using your own words and the official syllabus. |
| **fetch-execute** | Relates to this unit; define using your own words and the official syllabus. |
| **register** | Relates to this unit; define using your own words and the official syllabus. |
| **interrupt** | Relates to this unit; define using your own words and the official syllabus. |
| **assembler** | Relates to this unit; define using your own words and the official syllabus. |
| **bit shift** | Relates to this unit; define using your own words and the official syllabus. |
| **masking** | Relates to this unit; define using your own words and the official syllabus. |
        ...
        This subtopic sits inside **Processor Fundamentals**. At 9618 level, examiners reward **precise vocabulary** tied to **short explanations**. Start from a concrete picture (a device, a file, a wire), then name the abstract idea.
