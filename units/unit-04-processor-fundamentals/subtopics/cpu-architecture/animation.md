# Animation — Central Processing Unit (CPU) Architecture

## Purpose

Visual, step-by-step intuition for **Central Processing Unit (CPU) Architecture** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `CpuArchitectureModuleOverview`
...
```bash
manim -pql animations/scene.py CpuArchitectureModuleOverview
```
