# Practice — Central Processing Unit (CPU) Architecture

## Short answer

1. **State** the main focus of `Central Processing Unit (CPU) Architecture` in one sentence.
...
A school migrates systems. Give **two risks** and **two controls** relevant to `Central Processing Unit (CPU) Architecture`.
