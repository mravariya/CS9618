# Animation — Assembly Language

## Purpose

Visual, step-by-step intuition for **Assembly Language** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `AssemblyLanguageModuleOverview`
...
```bash
manim -pql animations/scene.py AssemblyLanguageModuleOverview
```
