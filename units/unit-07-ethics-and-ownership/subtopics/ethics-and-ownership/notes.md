# Ethics and Ownership
        ...
        **Syllabus:** Cambridge International AS & A Level Computer Science **9618** (Section 7.1)  
...
| --- | --- |
| **copyright** | Relates to this unit; define using your own words and the official syllabus. |
| **open source** | Relates to this unit; define using your own words and the official syllabus. |
| **shareware** | Relates to this unit; define using your own words and the official syllabus. |
| **professional ethics** | Relates to this unit; define using your own words and the official syllabus. |
| **AI impact** | Relates to this unit; define using your own words and the official syllabus. |
        ...
        This subtopic sits inside **Ethics and Ownership**. At 9618 level, examiners reward **precise vocabulary** tied to **short explanations**. Start from a concrete picture (a device, a file, a wire), then name the abstract idea.
