# Animation — Ethics and Ownership

## Purpose

Visual, step-by-step intuition for **Ethics and Ownership** (Cambridge 9618). Animations complement text—they do not replace the **syllabus** or **pseudocode guide**.

## Concepts visualised

- `EthicsAndOwnershipModuleOverview`
...
```bash
manim -pql animations/scene.py EthicsAndOwnershipModuleOverview
```
