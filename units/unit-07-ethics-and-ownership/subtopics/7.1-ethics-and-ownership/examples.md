# Guided examples — Ethics and Ownership
...
## Example D — Ethics and Ownership linkage

**Question:** Link **one idea** from `Ethics and Ownership` to another objective in **Ethics and Ownership**.
