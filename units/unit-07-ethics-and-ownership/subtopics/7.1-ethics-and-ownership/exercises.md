# Practice — Ethics and Ownership

## Short answer

1. **State** the main focus of `Ethics and Ownership` in one sentence.
...
A school migrates systems. Give **two risks** and **two controls** relevant to `Ethics and Ownership`.
